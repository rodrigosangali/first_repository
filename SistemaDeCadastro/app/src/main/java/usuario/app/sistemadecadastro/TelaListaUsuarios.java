...
public class TelaListaUsuarios {
    TelaPrincipalActivity act;
    TelaPrincipal tela_principal;
    Button btanterior, btproximo, btfechar;
    TextView txtnome, txttelefone, txtendereco, txtstatus;
    int index;

    public TelaListaUsuarios(TelaPrincipalActivity act, TelaPrincipal tela_principal) {
        this.act = act;
    ...
    public void CarregarTela() {
        ...
        {
            (new AlertDialog.Builder(act)).setTitle("Aviso").setMessage("Não existe nenhum registro cadastrado.").setNeutralButton("OK", null).show();
            return;
        }

        act.setContentView(R.layout.listagem_usuario_cadastrados);
